...
pkgdatadir = $(datadir)/MyNet
pkglibdir = $(libdir)/MyNet
pkgincludedir = $(includedir)/MyNet
top_builddir = .
...
DIST_COMMON = README $(am__configure_deps) $(srcdir)/Makefile.am \
	$(srcdir)/Makefile.in $(srcdir)/MyNet.desktop.in \
...
CONFIG_CLEAN_FILES = MyNet.desktop
SOURCES =
DIST_SOURCES =
...
mynetdocDATA_INSTALL = $(INSTALL_DATA)
DATA = $(gnomemenu_DATA) $(mynetdoc_DATA)
ETAGS = etags
CTAGS = ctags
...
ACLOCAL = ${SHELL} /home/cz/Projects/MyNet/missing --run aclocal-1.9
AMDEP_FALSE = #
AMDEP_TRUE = 
AMTAR = ${SHELL} /home/cz/Projects/MyNet/missing --run tar
AR = ar
AUTOCONF = ${SHELL} /home/cz/Projects/MyNet/missing --run autoconf
AUTOHEADER = ${SHELL} /home/cz/Projects/MyNet/missing --run autoheader
AUTOMAKE = ${SHELL} /home/cz/Projects/MyNet/missing --run automake-1.9
AWK = gawk
CATALOGS = 
CATOBJEXT = .gmo
CC = gcc
...
MAKEINFO = ${SHELL} /home/cz/Projects/MyNet/missing --run makeinfo
MKINSTALLDIRS = ./mkinstalldirs
MSGFMT = /usr/bin/msgfmt
NO_PREFIX_PACKAGE_DATA_DIR = share
NO_PREFIX_PACKAGE_DOC_DIR = doc/MyNet
NO_PREFIX_PACKAGE_HELP_DIR = share/gnome/help/MyNet
NO_PREFIX_PACKAGE_MENU_DIR = share/gnome/apps
NO_PREFIX_PACKAGE_PIXMAPS_DIR = share/pixmaps/MyNet
OBJEXT = o
PACKAGE = MyNet
PACKAGE_BUGREPORT = 
...
PACKAGE_DOC_DIR = /usr/local/doc/MyNet
PACKAGE_HELP_DIR = /usr/local/share/gnome/help/MyNet
...
PACKAGE_NAME = 
PACKAGE_PIXMAPS_DIR = /usr/local/share/pixmaps/MyNet
PACKAGE_STRING = 
PACKAGE_TARNAME = 
PACKAGE_VERSION = 
PATH_SEPARATOR = :
...
infodir = ${prefix}/info
install_sh = /home/cz/Projects/MyNet/install-sh
...
MyNet.desktop: $(top_builddir)/config.status $(srcdir)/MyNet.desktop.in
...
install-mynetdocDATA: $(mynetdoc_DATA)
	@$(NORMAL_INSTALL)
	test -z "$(mynetdocdir)" || $(mkdir_p) "$(DESTDIR)$(mynetdocdir)"
	@list='$(mynetdoc_DATA)'; for p in $$list; do \
	  if test -f "$$p"; then d=; else d="$(srcdir)/"; fi; \
	  f=$(am__strip_dir) \
	  echo " $(mynetdocDATA_INSTALL) '$$d$$p' '$(DESTDIR)$(mynetdocdir)/$$f'"; \
	  $(mynetdocDATA_INSTALL) "$$d$$p" "$(DESTDIR)$(mynetdocdir)/$$f"; \
	done

uninstall-mynetdocDATA:
	@$(NORMAL_UNINSTALL)
	@list='$(mynetdoc_DATA)'; for p in $$list; do \
	  f=$(am__strip_dir) \
	  echo " rm -f '$(DESTDIR)$(mynetdocdir)/$$f'"; \
	  rm -f "$(DESTDIR)$(mynetdocdir)/$$f"; \
	done
...
installdirs-am:
	for dir in "$(DESTDIR)$(gnomemenudir)" "$(DESTDIR)$(mynetdocdir)"; do \
...
install-data-am: install-gnomemenuDATA install-mynetdocDATA
...
.PHONY: $(RECURSIVE_TARGETS) CTAGS GTAGS all all-am am--refresh check \
	...
	install-info-am install-man install-mynetdocDATA install-strip \
